...
export const StatusIndicator = ({ status }) => {
  ...
  return (
    <div
      className={`px-[1rem] flex items-center w-fit py-[.5rem] rounded-[2rem] ${
        isAbandoned
          ? "bg-[#E7EAED] text-[#525964]"
          : isPositive
    ...
    >
      {isAbandoned ? (
        <CornerUpRight
          size={16}
          className="text-[#8895A7] w-[1.5rem] h-[1.5rem]"
          strokeWidth={2}
        />
      ) : isPositive ? (
        <Check
          size={16}
          className="text-[#12B76A] w-[1.5rem] h-[1.5rem]"
          strokeWidth={2}
        />
      ) : (
