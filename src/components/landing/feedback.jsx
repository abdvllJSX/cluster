        ...
        <section className="mt-[10rem]">
            <MaxContainer>
                <div className="container">
                    <h2 className="text-[4rem] w-[35rem] font-[600]">What businesses are saying</h2>
                    <div className="mt-[3rem] flex sm:flex-col justify-between">
                        {
...
const Card = ({ content, image, name, cardStyle, contentStyle, nameStyle }) => {
    return (
        <div className={`w-[32%] h-[40rem] sm:w-[100%] border ${cardStyle} rounded-[.8rem] flex flex-col p-[1.5rem]`}>
