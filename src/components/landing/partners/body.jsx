  ...
  const content = [
    {
      ...
      paragraph:
        "Trusted by 200,000+ businesses, Thousands of organizations of all sizes trust Paystack to grow their business.",
    },
    {
    ...
    },
    {
      ...
      header: "Opay",
      paragraph:
        "OPay  solutions make payments easier, transfers free, savings more rewarding and gives you cashback on airtime.",
    },
    {
      image: "/img/_nomba.png",
      header: "Nomba",
      paragraph:
        "With Nomba, you can accept payments faster and easier with our reliable POS terminals or via QR.",
    },
    {
      ...
      imagestyle: "w-[10rem]",
      paragraph:
        "Squad is a powerful payment platform that is designed to meet the needs of businesses of all sizes.",
    },
    {
      image: "/img/_fern.png",
      header: "Fern",
      imagestyle: "w-[12rem]",
      paragraph:
        "With the FERN payment gateway, merchants can conveniently accept payments, control finances, and track transactions.",
    },
  ];
...
const Content = ({ image, header, paragraph, imagestyle }) => (
  <div className="border border-[#D5D7DA] p-[1.5rem] rounded-[.8rem]">
    ...
    <h3 className="text-[1.8rem] text-[#181D27] font-[500] mb-[.5rem]">
      {header}
    </h3>
