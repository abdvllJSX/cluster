        ...
        <section className="py-[10rem] sm:pt-[7rem] sm:pb-[5rem]">
            <MaxContainer>
                <div className="container pt-[5rem] flex sm:flex-col items-center justify-between">
                    <div className="">
                        <h1 className="text-[5.5rem] sm:text-[3.5rem] sm:leading-[4.5rem] leading-[6rem] max-w-[55rem] font-[600]">Single point integration for online payment collection</h1>
                        <div className="mt-[4rem] flex sm:flex-col gap-[1rem]">
                            <Button className="text-white rounded-[.5rem] sm:w-full font-[600] py-[1.7rem] bg-[#FF9100] px-[1.8rem] text-[1.4rem]">Create an account</Button>
