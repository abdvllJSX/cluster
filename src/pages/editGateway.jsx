            ...
            <MaxContainer>
                <div className="container py-[10rem]">
                    <div className="mt-[3rem]">
                        ...
                        <h1 className="text-[3rem] my-[4rem] font-[600] text-[#000000]">Edit payment gateway</h1>
                        ...
                        <div className="mt-[3rem]">
                            ...
                            <div className="mt-[3rem]">
                                <Button className="w-fit px-[3.8rem] py-[2rem] rounded-[.7rem] bg-[#FF9100] text-[1.6rem] font-[600]">Update settings</Button>
