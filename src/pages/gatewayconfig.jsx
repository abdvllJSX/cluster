        ...
        <section>
            ...
            <MaxContainer>
                <div className="container pt-[12rem] pb-[15rem] sm:pt-[9rem]">
                    ...
                    <div className="">
                        <h1 className="header_i sm:text-[2.3rem] my-[4rem] sm:mb-[2rem]">Add paystack gateway</h1>
                        <div className="">
                            ...
                            selectedOption[1].check && (
                                <div className="mt-[3rem]">
                                    ...
                                    <div className="mt-[3rem] sm:w-full sm:flex-col gap-[2rem] flex items-center">
                                        <Button className="w-fit px-[3.8rem] py-[2rem] sm:w-full rounded-[.7rem] bg-[#FF9100] text-[1.6rem] font-[600]">Save settings</Button>

                                        <Button variant={'outline'} className="w-fit sm:w-full border-[#D5D7DA] px-[2rem] py-[2rem] rounded-[.7rem] text-[1.6rem] font-[600] shadow-[0px_1px_2px_0px_#0A0D120D]">Skip configuration settings</Button>
                                    </div>
                                </div>
                            )
                        }
