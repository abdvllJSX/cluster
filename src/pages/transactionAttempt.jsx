        ...
        <div className="container py-[10rem]">
          ...
          <div className="flex sm:flex-col gap-[5rem] justify-between">
            ...
            <div className="flex-1 border-[#E9EAEB] flex flex-col gap-[2rem] border rounded-[1rem] p-[3rem]">
              {Object.entries(attempts[activeAttemptIndex].info).map(
                ([key, value], index) => (
                  <div key={index} className="flex flex-col gap-[.5rem]">
                    <p className="text-[1.4rem] text-[#535862] font-[400]">
                      {key}
                    </p>
                    <p className="font-[500] text-[1.6rem] text-[#000000]">
                      {value}
                    </p>
                  </div>
                ),
  ...
  return (
    ...
    >
      <div className="text-start">
        ...
        <p className="text-[1.5rem] text-[#000000] font-[400]">
          {attempt.date}
        </p>
      </div>
