  ...
  const useCase = [
    {
      ...
      paragraph:
        "Your business is always ready to collect payments seamlessly, ensuring constant connectivity and uninterrupted transactions",
      content: [
        "100% conversion rate",
    ...
    },
    {
      ...
      paragraph:
        "Ensure your customers can always complete payments seamlessly, boosting your sales conversion and reducing cart abandonment.",
      content: [
    ...
    },
    {
      ...
      paragraph:
        "Get on-the-fly payment gateway insight and flip the switch on-the-go with our robust solution. ",
      content: [
    ...
    },
    {
      ...
      paragraph:
        "Perfect for businesses looking to improve checkout experience and maximize revenue by ensuring every transaction has the best chance of success.",
      content: [
    ...
    <>
      ...
      <section className="flex flex-col gap-[13rem] sm:gap-[7rem] py-[2rem]">
        {useCase.map((item, index) => (
          <PlaceTextBesideImage {...item} key={index} id={index} />
        ))}
      </section>
      <FeedBack />
      <Banner />
